...
public class AddressTranslator {
        ...
        public static void main(String[] args){
                ...
                try{
                	...
                	TLB tlb = new TLB();
                	//chose the method : LRU, FIFO, ORIGINAL
                	PageTable pt = new PageTable("LRU");
                	PhysicalMemory pm = new PhysicalMemory("LRU");
                	...
                	System.out.println(String.format("Page replacement: %s",pm.page_replace));
                } catch(Exception e){
                e.printStackTrace();
                System.exit(0);
                }
